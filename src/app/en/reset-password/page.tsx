...
export default function ResetPasswordPage() {
    ...
    useEffect(() => {
        ...
        const initSession = async () => {
            try {
                ...
                console.log("Reset password - tokens found:", !!accessToken);
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        if (password.length < 6) {
            setFormMessage({ text: "Password must be at least 6 characters", isError: true });
            return;
        }

        if (password !== confirmPassword) {
            setFormMessage({ text: "Passwords do not match", isError: true });
            return;
        }

        if (!supabaseClient) {
            setFormMessage({ text: "Please wait, loading...", isError: true });
            return;
        }
            ...
            <div className="container">
                ...
                {state === "error" && (
                    <>
                        ...
                        <p className="info-text">Please request a new password reset from the app.</p>
                    </>
                )}
                ...
                {state === "success" && (
                    <div className="success-container">
                        ...
                        <p className="subtitle">
                            Your password has been successfully changed. You can now sign in with your new password in
                            the Zodiac Flow app.
                        </p>
                    </div>
                )}
